...
import { ArcticMap, ArcticMapLayer, ArcticMapEdit, ArcticMapLLDSearch } from './ArcticMap'
  ...
  render() {
    return (
      <div style={{ width: '99vw', height: '99vh' }}>
        <ArcticMap search ref={this.am} onmapready={this.mapready.bind(this)}>

        <ArcticMapLayer
          type="geojson"
          src={this.state.points} template={this.geojsontemplate} onready={this.layerready.bind(this)} />
 ...
 */}
          ...
          {/* <ArcticMapEdit single point line polygon square circle onnewfeature={this.onnew} />
          <ArcticMapLLDSearch /> */}
