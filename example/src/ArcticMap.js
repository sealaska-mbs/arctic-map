...
var ArcticMapLLDSearch = function (_React$Component) {
    ...
    createClass(ArcticMapLLDSearch, [{
        ...
        value: function componentWillMount() {
            var self = this;
            reactArcgis.loadModules(['esri/Graphic', "esri/layers/FeatureLayer", "esri/layers/MapImageLayer", "esri/layers/ImageryLayer", "esri/tasks/IdentifyTask", "esri/tasks/support/IdentifyParameters", 'esri/geometry/Geometry', 'esri/geometry/Polygon']).then(function (_ref) {
                var _ref2 = slicedToArray(_ref, 8),
                    Graphic = _ref2[0],
                    FeatureLayer = _ref2[1],
                    MapImageLayer = _ref2[2],
